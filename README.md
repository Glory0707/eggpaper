...
- **六问**（右栏第一个页签）：读一篇论文该带着的问题——`要解决什么 / 为什么要解决 / 怎么解决的 / 还有什么没解决 / 还能做什么 / 换个学科怎么看`。**问题先出现，答案点开才看**：前三问的答案本来就是现成的（缺口段 / 主张-证据链 / 局限段 + 眉批"有坑"），后三问点「获取」才让模型写一两句，按篇缓存；还能做什么 / 换个学科两问的每条追问，一点就带进提问面板问出去

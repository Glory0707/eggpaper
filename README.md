...
- **方法卡**：把 Methods 整理成"目标/体系/条件/步骤/注意事项"的可复现 protocol；默认露目标/体系/条件 + 前三步，「展开全部」看余下步骤与注意事项。**综述自动换成谱系卡**（定位/对象/范围/脉络/入门建议）——它把领域梳理成了什么样子、分几条线、各线的代表工作，适合谁先读哪条；不预设数据集基准，综述有什么写什么

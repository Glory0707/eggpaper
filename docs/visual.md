...
5. **拖入时印记抬起**：空状态拖拽悬停时，整枚印记轻轻抬起并侧倾 2°——剥壳隐喻的动作化，仅在 dragover 态。
6. **析读完成印记一颤**：wordmark 里的标记 400ms 内 2° 摆动一次，只在析读完成瞬间。彩蛋级，别处不用。
...
- **宽窗（≥1180px）**：左条 46px + 书桌自适应 + 右栏 336px 三段式，右栏是**版面的一部分**。

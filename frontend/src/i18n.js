...
const EN = {
  ...
  '扫描件：能读能框选，七问答不了': 'Scanned PDF: readable and frame-askable, but no seven answers',
  ...
  '停止': 'Stop',
  '搜索…': 'Search…',
  '搜索标题或全文…': 'Search titles or full text…',
  '疑似同一篇论文': 'Probably the same paper',
  '刚导入的《{a}》和库里的《{b}》像是同一篇的不同版本。': '“{a}”, just imported, looks like another version of “{b}” in your library.',
  '两篇都保留': 'Keep both',
  '替换旧篇': 'Replace the old one',
  '已替换，问答、术语与分类都跟了过来': 'Replaced — Q&A, glossary and collections moved over.',
  '已替换；{n} 条页边卡在新版里找不回原句，没有跟迁': 'Replaced; {n} margin card(s) no longer match a sentence in the new version and were left behind.',
  '备份': 'Backup',
  '导出全库': 'Export library',
  '从备份恢复': 'Restore from backup',
  '恢复': 'Restore',
  '正在打包文库，稍候浏览器会下载 zip（库大要等一会儿）': 'Packing your library — the zip download starts shortly (large libraries take a moment).',
  '当前文库将被这份备份整体替换，重启 eggpaper 后生效。': 'Your current library will be replaced by this backup — takes effect after restarting eggpaper.',
  '备份已就位，重启 eggpaper 后生效': 'Backup staged — restart eggpaper to apply.',
  '导出引用表格': 'Export citation table',
  '基本信息': 'Basics',
  '参考文献条目': 'Reference entries',
  '短引用（PPT / 图注）': 'Short (slides / captions)',
  '导入与链接': 'Import & links',
  '正文括注': 'In-text citation',
  '至少选一种格式': 'Pick at least one format',
  '导出 CSV · {n} 篇': 'Export CSV · {n} papers',
  '导出中…': 'Exporting…',
  '{n} 篇还没识别过引用信息，这几行的引用列是空的': '{n} paper(s) have never had their citation info recognized — those rows are empty.',
  '一眼卡': 'Glance',
  '七问': 'Seven questions',
  '问答': 'Q&A',
  '正文': 'Body text',
  ...
  '《{name}》及其批注、析读、问答将一并删除。': '“{name}” and its notes, reading and Q&A will be deleted.',
  '这 {n} 篇及其批注、析读、问答将一并删除。': 'These {n} papers and their notes, reading and Q&A will be deleted.',
  '这篇已被删除': 'This paper was deleted',
  'AI 眉批都已收起 ·': 'All AI notes folded away ·',
  '筛选标题…': 'Filter titles…',
  '「{t}」的问答将删除，论文与批注不受影响。': 'Q&A in “{t}” will be deleted; the paper and its notes are kept.',
  'deepseek（不推荐）': 'deepseek (not recommended)',
  '检查更新': 'Check for updates',
  '已迁移，重启后生效': 'Moved — takes effect after restart',
  '复制失败': 'Copy failed',

...
const EN = {
  ...
  '翻译中': 'Translating',
  '正在译{svc}{cur} · 已用 {t}': 'Translating{svc}{cur} · {t} elapsed',
  '第{p}页': 'pages {p}',
  '刚刚': 'just now',
  '键盘': 'Keyboard',
  ...
  '文库里有 {n} 篇——去挑一篇': '{n} papers in the library — pick one',
  '翻译中…': 'Translating…',
  '已全文翻译': 'Fully translated',
  ...
  '文库、批注与配置将迁到：{p}。重启后生效。': 'The library, annotations and config will move to: {p}. Restart to apply.',
  ...
  '《{a}》和库里的《{b}》像是同一篇的不同版本。': '“{a}” looks like another version of “{b}” in your library.',
  '两篇都保留': 'Keep both',
